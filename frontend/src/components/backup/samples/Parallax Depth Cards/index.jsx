        ...
        >
          ...
          {/* <div
            ...
            style={{
              ...
              // backgroundImage: `url("./sample_imgs/person.jpg")`,
              backgroundImage: `url("./sample_imgs/winter.png")`,
              // backgroundImage: `url("./sample_imgs/아이.webp")`,
              // backgroundImage: `url("./sample_imgs/student.jpeg")`,
              width: '80%',
              height: '80%',
            }}
          /> */}
          <img
            ...
            style={{
              // width: '100%',
              height: '100%',
              transform: `translateX(${mousePX() * 40}px) translateY(${mousePY() * 40}px) rotateY(${
                mousePX() * 30
              }deg) rotateX(${mousePY() * -30}deg)`,
            }}
          />
          <div className={`${styles.card_info}`}>{children}</div>
        </div>
        {/* <img
          className={`${styles.card_bg}`}
          src=".\sample_imgs\butterfly.jpg"
